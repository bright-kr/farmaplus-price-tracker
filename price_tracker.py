...
Info  : https://brightdata.co.kr/products/insights/price-tracker/farmaplus
"""
...
# https://brightdata.co.kr/products/web-scraper/farmaplus
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Farmaplus scraper at: https://brightdata.co.kr/products/web-scraper/farmaplus\n"
